...
void (*FunctionTable[0xFF]) = 
{
	...
	/*--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
	/*0x00  |*/Break,			  OrAccMemIndexInd,          UndocOp,		 UndocOp,        UndocOp,        OrAccMemZp,             ShlZp,                  UndoOp,         PushProgramCounter,     OrAccMemImm,                ShlAcc,             UndocOp,        UndocOp,        OrAccMemAbs,                ShlAbs,                 UndocOp,
	/*0x10  |*/BranchNotNegative, OrAccMemIndIndex,          UndocOp,		 UndocOp,        UndocOp,        OrAccMemZpIndex,        ShlZpIndex,             UndocOp,        ClearCarry,             OrAccMemAbsIndexY,          UndocOp,            UndocOp,        UndocOp,        OrAccMemAbsIndex,           ShlAbsIndex,            UndocOp,
	/*0x20  |*/JumpSubroutine,    AndIndexInd,	             UndocOp,		 UndocOp,        BitTestZp,      AndZp,                  RotateLeftZp,           UndocOp,        PopProgramCounter,      AndImm,                     RotateLeftAcc,      UndocOp,        BitTestAbs,     AndAbs,                     RotateLeftAbs,          UndocOp,
	/*0x30  |*/BranchNegative,    AndIndIndex,               UndocOp,        UndocOp,        UndocOp,        AndZpIndex,             RotateLeftZpIndex,      UndocOp,        SetCarry,               AndAbsIndexY,               UndocOp,            UndocOp,        UndocOp,        AndAbsIndexX,               RotateLeftAbsIndexX,    UndocOp
	/*0x40  |*/ReturnInterrupt,   XorAccMemIndexInd,         UndocOp,        UndocOp,        UndocOp,        XorAccMemZp,            ShrZp,                  UndocOp,        PushAcc,                XorAccMemImm,               ShrAcc,             UndocOp,        JumpAbs,        XorAccMemAbs,               ShrAbs,                 UndocOp,
	/*0x50  |*/BranchNoOveflow,   XorAccMemIndIndex,         UndocOp,        UndocOp,        UndocOp,        XorAccMemZpIndex,       ShrZpIndex,             UndocOp,        ClearInterrupts,        XorAccMemAbsIndexY,         UndocOp,            UndocOp,        UndocOp,        XorAccMemAbsIndexX,         ShrAbsIndexX,           UndocOp,
	/*0x60  |*/ReturnSubroutine,  AddCarryIndexInd,          UndocOp,        UndocOp,        UndocOp,        AddCarryZp,             RotateRightZp,          UndocOp,        PopAccumulator,         AddCarrImm,                 RotateRightAcc,     UndocOp,        JumpInd,        AddCarryAbs,                RotateRightAbs,         UndocOp,
	/*0x70  |*/BranchOverflow,    AddCarryIndIndex,          UndocOp,        UndocOp,        UndocOp,        AddCarryZpIndex,        RotateRightZpIndex,     UndocOp,        SetInterruptDisable,    AddCarrAbsIndexY,           UndocOp,            UndocOp,        UndocOp,        AddCarryAbsIndexX,          RotateRightAbsIndexX,   UndocOp,
	/*0x80  |*/UndocOp,           StoreAccIndexInd,          UndocOp,        UndocOp,        StoreYZp,       StoreAccZp,             StoreXZp,               UndocOp,        DecrementY,             UndocOp,                    TransferXToAcc,     UndocOp,        StoreYAbs,      StoreAccAbs,                StoreXAbs,              UndocOp,
	/*0x90  |*/BranchCarryClear,  StoreAccIndIndex,          UndocOp,        UndocOp,        StoreYZpIndex,  StoreAccZpIndex,        StoreXZpIndex,          UndocOp,        TransferYToAcc,         StoreAccAbsIndexY,          TransferXToStack,   UndocOp,        UndocOp,        StoreAccAbsIndexX,          UndocOp,                UndocOp,
	/*0xA0  |*/LoadYImm,          LoadAccIndexInd,           LoadXImm,       UndocOp,        LoadYZp,        LoadAccZp,              LoadXZp,                UndocOp,        TransferAccToY,         LoadAccImm,                 TransferAccToX,     UndocOp,        LoadYAbs,       LoadAccAbs,                 LoadXAbs,               UndocOp,
	/*0xB0  |*/BranchCarrySet,    LoadAccIndIndex,           UndocOp,        UndocOp,        LoadYZpIndex,   LoadAccZpIndex,         LoadXZpIndex,           UndocOp,        ClearOverflow,          LoadAccAbsIndexY,           TransferStackToX,   UndocOp,        LoadYAbsIndex,  LoadAccAbsIndexX,           LoadXAbsIndex,          UndocOp,
	/*0xC0  |*/CmpYImm,           CmpAccIndexInd,            UndocOp,        UndocOp,        CmpYZp,         CmpAccZp,               DecrementZp,            UndocOp,        IncrementY,             CmpAccImm,                  DecrementX,         UndocOp,        CmpYAbs,        CmpAccAbs,                  DecrementAbs,           UndocOp,
	/*0xD0  |*/BranchNotZero,     CmpAccIndIndex,            UndocOp,        UndocOp,        UndocOp,        CmpAccZpIndex,          DecrementMemZpIndex,    UndocOp,        ClearDecimal,           CmpAccAbsIndexY,            UndocOp,            UndocOp,        UndocOp,        CmpAccAbsIndexX,            DecrementMemAbsIndex,   UndocOp,
	/*0xE0  |*/CmpXImm,           SubtractAccMemIndexInd,    UndocOp,        UndocOp,        CmpXZp,         SubtractAccMemZp,       IncrementMemZp,         UndocOp,        IncrementX,             SubtractAccMemImm,          NoOperation,        UndocOp,        CmpXAbs,        SubtractAccMemAbs,          IncrementMemAbs,        UndocOp,
	/*0xF0  |*/BranchZero,        SubtractAccMemIndIndex,    UndocOp,        UndocOp,        UndocOp,        SubtractAccMemZpIndex,  IncrementMemZpIndex,    UndocOp,        SetDecimal,             SubtractAccMemAbsIndexY,    UndocOp,            UndocOp,        UndocOp,        SubtractAccMemAbsIndexX,    IncrementMemAbsIndex,   UndocOp
};
